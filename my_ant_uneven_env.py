...
class AntSoftEnv(MujocoEnv, gym.utils.EzPickle):
    ...
    metadata = {
        ...
        "render_fps": 20, # frame_skip=5なので、5 * 20 = 100 Hz
    }

    def __init__(self, **kwargs):
        # XMLファイルへのパスを解決
        xml_path = os.path.join(os.path.dirname(__file__), "assets", "ant_uneven.xml")
    ...
    def _get_reward(self, obs):
        ...
        healthy_reward = self._check_terminated(obs) * 1.0 # 生存している間は1.0
...
register(
    id="AntUneven-v0",
    entry_point="my_ant_env:AntUnevenEnv",
